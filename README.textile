...
To give Tarsos a try you can "start Tarsos using JAVA WebStart":http://tarsos.0110.be/attachment/tarsos.jnlp or download the "executable Tarsos JAR-file":http://tarsos.0110.be/attachment/tarsos.jar. A JAVA 5 runtime is required, JAVA 6 preferred. An "API reference for Tarsos":http://tarsos.0110.be/attachment/doc/ is also available. 
