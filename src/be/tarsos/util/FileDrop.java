...
//import be.tarsos.util.FileDrop.TransferableObject;
...
public final class FileDrop {
	 ...
	 *      Transferable xfer = new be.tarsos.util.FileDrop.TransferableObject( myObj );
	 *      ...
	 * </code>
	 * </pre>
	 * 
	 ...
	 * 
	 *      TransferableObject.Fetcher fetcher = new be.tarsos.util.FileDrop.TransferableObject.Fetcher()
	 *      {   public Object getObject(){ return myObj; }
	 *      }; // end fetcher
	 * 
	 *      Transferable xfer = new be.tarsos.util.FileDrop.TransferableObject( fetcher );
	 *      ...
	 * </code>
	 * </pre>
	 * 
	...
	public static class TransferableObject implements java.awt.datatransfer.Transferable {
		 ...
		 * @since 1.1
		 */
		public TransferableObject(@SuppressWarnings("rawtypes") final Class dataClass, final Fetcher fetcher) {
			this.fetcher = fetcher;
