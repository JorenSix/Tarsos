...
public class MidiUtils {
	 ...
	 */
	public static void sendTuningChange(Receiver recv, int channel, int tuningpreset) throws InvalidMidiDataException {
		// Data Entry
	 ...
	 * @throws InvalidMidiDataException
	 */
	public static void sendTunings(Receiver recv, int bank, int preset, String name, double[] tunings) throws IOException,
		...
		SysexMessage msg = MidiUtils.MidiTuningStandard.keyBasedTuningDump(MidiUtils.ALL_DEVICES, bank, preset, name, itunings);
		recv.send(msg, -1);
	}
	...
	public static class DeviceControl {
		...
		public static SysexMessage setGlobalParameter(int targetDevice, short[] slotpath, byte[] parameter, int value) throws IOException,
				InvalidMidiDataException {
			return setGlobalParameter(targetDevice, slotpath, parameter, new byte[] { (byte) value });
		}

		public static SysexMessage setGlobalParameter(int targetDevice, short[] slotpath, byte[] parameter, byte[] value)
		...
		public static class ChorusEffect {
			...
			public static SysexMessage setChorusSendToReverb(int targetDevice, int reverbType) throws IOException, InvalidMidiDataException {
				return setGlobalParameter(targetDevice, SLOTPATH_EFFECT_CHORUS, CHORUS_SEND_TO_REVERB, reverbType);
			}
		}
	}
	...
	public static class KeyBasedInstrumentControl {
		...
		public static SysexMessage setKeyBasedControl(int targetDevice, int midi_channel, int key_number, int control, int value)
				throws IOException, InvalidMidiDataException {
			return setKeyBasedControl(targetDevice, midi_channel, key_number, new int[] { control }, new int[] { value });
		}

		public static SysexMessage setKeyBasedControl(int targetDevice, int midi_channel, int key_number, int[] controls, int[] values)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
	...
	public static class DestinationSettings {
		...
		public static SysexMessage setControllerDestinationForChannelPressure(int targetDevice, int channel, int[] controls, int[] ranges)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage setControllerDestinationForPolyPressure(int targetDevice, int channel, int[] controls, int[] ranges)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage setControllerDestinationForControlChange(int targetDevice, int channel, byte control, int[] controls,
	...
	public static class MidiTuningStandard {
		...
		public static SysexMessage scaleOctaveTuningDump1ByteForm(int targetDevice, int bank, int preset, String name, int[] tuning)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage scaleOctaveTuningDump2ByteForm(int targetDevice, int bank, int preset, String name, int[] tuning)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage singleNoteTuningChange(int targetDevice, boolean realtime, int bank, int preset, int[] key_numbers,
		...
		public static SysexMessage singleNoteTuningChange(int targetDevice, int preset, int[] key_numbers, int[] key_tunings)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage keyBasedTuningDump(int targetDevice, int preset, String name, int[] tunings) throws IOException,
				InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
		...
		public static SysexMessage keyBasedTuningDump(int targetDevice, int bank, int preset, String name, int[] tunings)
				throws IOException, InvalidMidiDataException {
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			baos.write(UNIVERSAL_NON_REALTIME_SYSEX_HEADER);
			baos.write((byte) targetDevice);
