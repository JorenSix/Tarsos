...
public class ConfigurationTest {
	...
	public void testGetBoolean() {
		String originalValue = Configuration.get(ConfKey.audio_file_name_pattern);
		assertEquals(false, Configuration.getBoolean(ConfKey.audio_file_name_pattern));
		...
		assertEquals(true, Configuration.getBoolean(ConfKey.audio_file_name_pattern));

		Configuration.set(ConfKey.audio_file_name_pattern, "  TRuE  ");
		assertEquals(true, Configuration.getBoolean(ConfKey.audio_file_name_pattern));

		Configuration.set(ConfKey.audio_file_name_pattern, originalValue);
		assertEquals(originalValue, Configuration.get(ConfKey.audio_file_name_pattern));
	}
	...
	public void testUseCorrectSeparator() {
		...
		Configuration.set(ConfKey.data_directory, "dire" + incorrectSeparator + "ctory");
		assertEquals("dire" + File.separatorChar + "ctory", Configuration.get(ConfKey.data_directory));
