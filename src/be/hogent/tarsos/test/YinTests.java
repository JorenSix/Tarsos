...
public class YinTests {
    ...
    public void compareWithAubioYin() {
        ...
        for (AudioFile file : files) {
            ...
            toneScaleHistogramAubio.plot("data/tests/yin_tests/" + file.basename() + "_aubio.png", file
                    .basename());
            ...
            toneScaleHistogramJava.plot("data/tests/yin_tests/" + file.basename() + "_yin.png", file
                    .basename());
