...
public class EuclideanDistance implements HistogramCorrelation {
	...
	/* (non-Javadoc)
	 * @see tarsos.util.histogram.HistogramCorrelation#plotCorrelation(tarsos.util.histogram.Histogram, int, tarsos.util.histogram.Histogram)
	 */
	public void plotCorrelation(Histogram thisHistogram, int displacement, Histogram otherHistogram) {
		//for the moment this plots the intersection (not the euclidean distance)
