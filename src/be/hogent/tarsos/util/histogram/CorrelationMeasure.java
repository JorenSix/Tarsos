...
/**
 *
 * Defines a correlation measure for histograms. See On measuring the distance between histograms:
 * Sung-Hyuk Chaa, Sargur N. Sriharib (2002)
 *
 * CorrelationMeasure is a bit of a strange name: also distance measures are defined.
 *
...
public enum CorrelationMeasure{
	 ...
	 * It is a symmetric correlation measure: 1.0 is perfect correlation, 0.0 means no correlation.
	...
	/**
	 * Another correlation measure, seems to work also,
	 * TODO Write better description
	 */
	...
	/**
	 * @return the HistogramCorrelation instance used to caluculate the distance / correlation
	 */
