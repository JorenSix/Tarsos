 ...
 * Makes it easy to switch FFT algorithm with minimal overhead.
 *
 * @author Joren Six
 *
 */
public class FFT {
	 ...
	 * @return The modulus, magnitude or absolute value
	...
	private static class FloatFFT{
		 private final float[] w;
		     ...
		     * @param fftFrameSize Framesize must be power of 2
		     * @param sign Sign = -1 is FFT, 1 is IFFT (inverse FFT)
		     */
