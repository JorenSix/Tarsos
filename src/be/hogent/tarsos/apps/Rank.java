...
public final class Rank extends AbstractTarsosApp {
    ...
    public void run(final String... args) {
        ...
        final OptionSpec<File> needleSpec = parser.accepts("needle",
        "A scala or audio file that defines the tone scale to look for.").withRequiredArg()
        .ofType(File.class);

        final OptionSpec<File> haystackSpec = parser.accepts("haystack",
        "A list of audio or scala files to match needle with. If one of the files is a directory it is traversed recursively.")
