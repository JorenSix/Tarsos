...
public class ShowMelody {
    ...
    public static void testTonalShiftWithinFile(String fileName) {
         ...
         * FileUtils.basename(fileName) + "_octave.txt", samples);
         * 
         * //Histogram firstQuarterFrequencyTable =
         * Sample.printOctaveInformation(detector.getName() + "_" +
         ...
         * fourthQuarterFrequencyTable =
         * fourthQuarterFrequencyTable.normalize();
         * 
    ...
    public static void findBestTonalShift(List<String> fileNames) {
         ...
         * samples.subList(samples.size()/2,samples.size()));
         * 
         * firstHalf = firstHalf.normalize(); secondHalf =
    ...
    public static void findBestMatch(List<String> fileNames) {
         ...
         * AubioPitchDetection(new AudioFile(fileNames.get(i)),
         * AubioPitchDetectionMode.YIN)); detectors.add(new
         * IPEMPitchDetection(new AudioFile(fileNames.get(i)))); detector = new
         ...
         * histogramJ.normalize().gaussianSmooth(1.0);
         * 
         * int displacement =
         ...
         * "\tdisplacement:\t" + displacementInCents); } } }
         * 
         * SimplePlot plot = new SimplePlot("best_correlation_shift" +
         * bestFileName); plot.addData(0,bestFirst); int displacement = (int)
         * (bestDisplacementInCents/bestFirst.getClassWidth());
         * plot.addData(1,bestSecond,displacement);
         * 
         * plot.save();
    ...
    public static void main(String[] args) {
         ...
         * detector.executePitchDetection(); samples = detector.getSamples();
    ...
    public static void bestDetector(String fileName) {
         ...
         * 
         * for(int i = 0;i<histograms.size();i++){ for(int j = i +
