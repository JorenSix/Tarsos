...
public class HistogramSummationTest {
	...
	/**
	 * Tests if summing histograms constructed with
	 * different pitch extractors is useful.
	 */
	public static void main(String[] args) {
		...
		toneScaleHistogramTarsosYin
			.add(toneScaleHistogramAbioYin)
			.add(toneScaleHistogramIPEM)
			.normalize()
			.gaussianSmooth(1.0)
			.plot("data/tests/added.png","Aubio + Tarsos + Ipem");
	}
}
