 ...
 * 
 * Factors affecting music retrieval in query-by-melody De Mulder, Tom; Martens,
 * Jean; PAUWS, S; VIGNOLI, F et al. IEEE TRANSACTIONS ON MULTIMEDIA (2006)
 * Recent improvements of an auditory model based front-end for the
 * transcription of vocal queries
 * 
 ...
 * 
 * The text file generated by the pitch detector consists of 12 columns: 6 times
 * a frequency in Hertz followed by a probability. The frequencies are ordered
	...
	public void executePitchDetection() {
		...
		for (String[] row : csvData) {
			for (int index = 0; index < 6; index++) {
				...
				Double pitch = row[index * 2].equals("-1.#IND00") || row[index * 2].equals("-1.#QNAN0") ? 0.0 : Double
