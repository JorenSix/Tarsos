...
public interface PitchDetector {
	 ...
	 * Should take care of caching annotations: 
	 * e.g. execute the annotation process once per song, 
	 * write a CSV-file with annotations and read that file when needed  
	 */
